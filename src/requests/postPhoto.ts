import { postFetch } from "../postReuse.js";
import { URL } from "../url.js";
import { messageErrorElement, validarInputs } from "../validarInput.js";

export class PostPhoto{
    formElement:HTMLFormElement | null;
    inputs:NodeList | undefined;
    formPostPublish:FormData | null;
    erroElementSpan:NodeList | null;
    elementsComplete:Array<boolean>;
    constructor(){
    ...
    async fetchPost(){
        ...
        if(dados){
            console.log('teste')
            const inputFile:Node | null = this.inputs ? this.inputs[3] : null
